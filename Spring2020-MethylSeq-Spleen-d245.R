...
BiocManager::install("methAnalysis")
packageVersion("BiocVersion")
packageVersion("org.Bt.eg.db")
BiocManager::install("org.Hs.eg.db")
BiocManager::install("annotate")
BiocManager::install("AnnotationDbi", "backports", "")
BiocManager::valid()
...
getwd()
setwd("/lab_data/hansen_lab/hanahm1/Methyl-Seq/Methyl-Seq_Data/BAM_Alignments")

##############################################################################
date <- "02.17.2020"
folder <- "/lab_data/hansen_lab/hanahm1/Methyl-Seq/Methyl-Seq_Data/DMRs/methylKit/"


bam.list <- list("zr2831_1.sort.bam", "zr2831_2.sort.bam", "zr2831_3.sort.bam", "zr2831_4.sort.bam", "zr2831_5.sort.bam", "zr2831_6.sort.bam", "zr2831_7.sort.bam")
ids <- list("272.C", "268.C", "278.C", "250.C", "842.PI", "307.PI", "308.PI")
treatment.list <- c(0,0,0,0,1,1,1) #treatment group = 1 and controls = 0
class(treatment.list[1])
